...
export function CatalogBanner({ catalog }: CatalogBannerProps) {
  ...
  return (
    <div className="mb-8 rounded-lg glass-panel p-4">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h3 className="text-base font-semibold">Buy the Complete Catalog</h3>
          <p className="text-sm text-muted-foreground">
            All {catalog.releaseCount} releases — {catalog.discountPercent}% off
          </p>
